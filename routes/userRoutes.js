...
router.post('/mark-as-seen', authMiddleware, async (req, res) => {
    try {
        const user = await User.findOne({ _id: req.body.userId })
...
router.post('/get-info-by-id', authMiddleware, async (req, res) => {
...
router.post('/apply-doctor-account', authMiddleware, async (req, res) => {
    try {
        ...
        res.send({ message: 'Error applying doctor account', success: false, error })
    }
})
